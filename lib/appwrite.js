...
export const createUser = async (email, password, account_number, phone) =>{
try {
...
export const updateUserProfile = async (userId, { city, barangay, street, phone, password, email }) => {
  try {
